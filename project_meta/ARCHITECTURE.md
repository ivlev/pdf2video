...
- находит области интереса (ROI) через `EnhancedDetector`
...
- **Render Cache:** Постоянное кэширование отрендеренных страниц PDF на диске.
- **Memory Manager:** Контроль лимитов ОЗУ и динамическое масштабирование количества воркеров (защита от OOM).

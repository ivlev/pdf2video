...
**Версия:** 0.91 (Smart Directing 2.0: Scorer & Optimizer)
**Дата:** 2026-02-23
...
- **Analyze:** Детекция регионов интереса (заголовки, текст) через `EnhancedDetector` с учетом плотности граней и вариативности цвета.
